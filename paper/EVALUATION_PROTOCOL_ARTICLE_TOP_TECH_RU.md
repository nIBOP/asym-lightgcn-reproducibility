...
В российских публикациях последних лет близкие вопросы обсуждаются в работах об архитектурах рекомендательных систем [14] и графовых нейронных сетях в электронной коммерции [15]. Отдельно рассматриваются метрики качества рекомендаций [16], холодный старт, разреженность данных и коррекция релевантности [17, 18]. Для предлагаемого протокола важна эта методическая линия: результат модели рассматривается не как одно число, а как следствие условий эксперимента.
