...
Для графовых рекомендательных моделей это особенно заметно. LightGCN остается сильной базовой моделью совместной фильтрации [1], NCL усиливает графовые представления контрастивным обучением [2], однако их корректное сравнение требует единого разбиения данных, полного ранжирования или корректной выборки негативных объектов и сопоставимых настроек обучения [3, 4]. Дополнительную неопределенность вносят популярностное смещение [5-7] и содержательные признаки объектов: текст, категории и метаданные могут давать семантический короткий путь без полноценного графового обучения [8-11].
