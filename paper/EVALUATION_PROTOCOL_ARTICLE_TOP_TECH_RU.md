...
Для графовых рекомендательных моделей это особенно заметно. LightGCN остается сильной базовой моделью совместной фильтрации [1], а NCL усиливает графовые представления контрастивным обучением [2]. Современные обзоры фиксируют устойчивый интерес к графовым нейронным сетям в рекомендательных задачах [19]. Однако корректное сравнение таких моделей требует единого разбиения данных, полного ранжирования или корректной выборки негативных объектов и сопоставимых настроек обучения [3, 4]. Дополнительную неопределенность вносит популярностное смещение: оно проявляется уже в простых стратегиях переранжирования [5] и подробно обсуждается в современных обзорах [6, 7]. Содержательные признаки объектов - текст, категории и метаданные - также могут давать семантический короткий путь без полноценного графового обучения; это видно как в классических гибридных подходах [8, 9], так и в современных работах о самообучении и контрастивном обучении в рекомендательных системах [10, 11].
...
Таблица 1 - Характеристики экспериментальных срезов данных
...
Таблица 2 - Результаты на вариантах Amazon
...
Таблица 3 - Сводная проверка устойчивости ключевых сравнений
...
Рисунок 1 - Доля рекомендаций непопулярных объектов в первых десяти рекомендациях
...
20. Bekheet M. Amazon Books Reviews [Набор данных; версия Kaggle, обновление страницы 2022] // Kaggle. URL: https://www.kaggle.com/datasets/mohamedbakhet/amazon-books-reviews/data (дата обращения: 28.06.2026).
21. Banik R. The Movies Dataset [Набор данных; версия Kaggle, 2017] // Kaggle. URL: https://www.kaggle.com/datasets/rounakbanik/the-movies-dataset/data (дата обращения: 28.06.2026).
...
Дубровин В. В.: разработка концепции, методология исследования, работа с данными, анализ данных, проведение исследования, программная реализация, подготовка и редактирование текста рукописи. Алаторцев Е. И.: научное руководство, постановка исследовательской задачи, методологическая экспертиза, редактирование текста рукописи. Бабкин И. А.: обсуждение экспериментальной постановки, проверка интерпретации результатов, редактирование текста рукописи.
